"""Этап 6: прогон V0 (дефолты) партии B (S06, S07, S08, S09) на dev 2023-2025.
...
Запуск: python scripts/run_dev_batch_b.py
"""
...
def main():
    ...
    out_path = PROJECT_ROOT / "reports" / "dev" / "batch_B.md"
